...
contract BasicToken is ERC20Basic {
  ...
  function _transfer(address _from, address _to, uint256 _value) returns (bool) {
...
contract MNT01Token is StandardToken {
   ...
   */
  function MNT01Token(uint256 initialSupply, string tokenName, string tokenSymbol) {
